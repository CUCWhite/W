...
public class TeachOne : MonoBehaviour {
	...
	void FixedUpdate () {
        ...
        if (hor < 0 || Input.GetKeyDown(KeyCode.LeftArrow) && !iskeydown[0])
        {
            iskeydown[0] = true;
        ...
        if (hor > 0 || Input.GetKeyDown(KeyCode.RightArrow) && !iskeydown[1]&&iskeydown[0])
        {
            iskeydown[1] = true;
    ...
    void showsub()
    {
        ...
        if (Input.GetButtonDown("Jump") && !iskeydown[2])
        {
            iskeydown[2] = true;
